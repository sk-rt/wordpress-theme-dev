...
{
    wp_enqueue_script('myguten-script', get_stylesheet_directory_uri() . '/admin/js/gutenberg-custom.js', array('wp-blocks', 'wp-dom-ready', 'wp-edit-post'), '1.1.1', false);
}
add_action('enqueue_block_editor_assets', 'my_gutenberg_enqueue');

/**
 *  ブロックエディターの不要なpatternを削除
 */
